      ...
      <v-flex xs12 sm8 md8>
        ...
        <v-card class="elevation-12"> 
          ...
          <v-card-title primary-title>
            <h3 class="headline mb-0">Edit category
...
<script type="text/javascript">
  ...
  export default {
    ...
    mounted() {
      this.form.get(`/api/categories/${this.$route.params.category_id}`)
        .then(data => {
    ...
    methods: {
      ...
      update() {
        this.form.patch(`/api/categories/${this.$route.params.category_id}`)
          .then(data  =>  {
